...
create policy "Users can view their own special_dates" on public.special_dates for select using (auth.uid() = user_id);
create policy "Users can view their own savings_goals" on public.savings_goals for select using (auth.uid() = user_id);
create policy "Users can view their own weekly_goals" on public.weekly_goals for select using (auth.uid() = user_id);
create policy "Users can view their own monthly_notes" on public.monthly_notes for select using (auth.uid() = user_id);
...
create policy "Users can insert their own special_dates" on public.special_dates for insert with check (auth.uid() = user_id);
create policy "Users can insert their own savings_goals" on public.savings_goals for insert with check (auth.uid() = user_id);
create policy "Users can insert their own weekly_goals" on public.weekly_goals for insert with check (auth.uid() = user_id);
create policy "Users can insert their own monthly_notes" on public.monthly_notes for insert with check (auth.uid() = user_id);
...
create policy "Users can update their own special_dates" on public.special_dates for update using (auth.uid() = user_id) with check (auth.uid() = user_id);
create policy "Users can update their own savings_goals" on public.savings_goals for update using (auth.uid() = user_id) with check (auth.uid() = user_id);
create policy "Users can update their own weekly_goals" on public.weekly_goals for update using (auth.uid() = user_id) with check (auth.uid() = user_id);
create policy "Users can update their own monthly_notes" on public.monthly_notes for update using (auth.uid() = user_id) with check (auth.uid() = user_id);
...
create policy "Users can delete their own special_dates" on public.special_dates for delete using (auth.uid() = user_id);
create policy "Users can delete their own savings_goals" on public.savings_goals for delete using (auth.uid() = user_id);
create policy "Users can delete their own weekly_goals" on public.weekly_goals for delete using (auth.uid() = user_id);
create policy "Users can delete their own monthly_notes" on public.monthly_notes for delete using (auth.uid() = user_id);